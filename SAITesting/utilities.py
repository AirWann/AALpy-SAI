...
from aalpy.base.BooleanAlgebra import IntervalPredicate, MonotonicAlgebra, Predicate, BooleanAlgebra, IntervalAlgebra, OrPredicate, GenIntPredicate
import numpy as np
...
def generate_sfa(nb_states, algebra: BooleanAlgebra = IntervalAlgebra(), element_generator = None) -> Sfa:
    ...
    """
    if element_generator is None and not isinstance(algebra, IntervalAlgebra):
        raise ValueError("If no element_generator is provided, the algebra must be IntervalAlgebra.")
    states = []
